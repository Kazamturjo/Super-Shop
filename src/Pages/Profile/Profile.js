...
const Profile = () => {
  ...
  <img class="inline-flex object-cover border-4 border-indigo-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 bg-indigo-50 text-indigo-600 h-24 w-24 md:h-48 md:w-48" src="https://media.licdn.com/dms/image/D5603AQF5axjAf22Lrg/profile-displayphoto-shrink_800_800/0/1710386656687?e=2147483647&v=beta&t=tyUx33aMM7DY08w_WbBAOr-Bq0xhAiBkenzc6diOw8o" alt=""/>
  <h1 class="text-2xl text-gray-500 font-bold mt-2">
    Johh Doe
  </h1>
  <h2 class="text-base md:text-xl text-gray-500 font-bold pt-5">
