...
const Cart = ({ cart, setCart }) => {
  ...
  return (
    <div className="flex justify-center mt-8 z-50 fixed">
      <div className="relative z-10" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
        <div className="fixed inset-0 bg-gray-500 bg-opacity-110 transition-opacity"></div>
                  ...
                  <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                    <div className="lg:flex items-start justify-between">
                      ...
                      <div className="ml-3 flex h-7 items-center">
                        <button onClick={handleClose} type="button" className=" relative text-gray-800 hover:text-gray-500">
