      ...
      >
        ...
        <div className="inline-flex">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={`w-10 h-9  bg-amber-300 text-4xl font-bold rounded  cursor-pointer duration-500 ${
              open && 'rotate-[360deg] '
            } ${!open && 'w-10 h-9'} block float-left  mr-2 `}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
